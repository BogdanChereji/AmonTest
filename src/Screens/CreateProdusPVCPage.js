...
function CreateProdusPVC() {
  ...
  //Campuri
  const [Nume, setNume] = useState('Lamela');
        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <FormGroup>
                <TextField
                  ...
                  id="numeCuloareC1"
                  label="Introduceți tipul lamelei"
                  variant="outlined"
            ...
            <Grid item xs={isSmallScreen ? 12 : 12}>
              <Typography> Pretul lamelei</Typography>
              <FormGroup>
                <TextField
                  controlid="Pret"
                  sx={{ mt: 2 }}
                  id="Pret"
                  label="Introduceți pretul culorii lamelei"
                  variant="outlined"
...
export default CreateProdusPVC;
