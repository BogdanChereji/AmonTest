...
function CreateProdusPlasaCuClema9x32() {
  ...
  //Campuri
  const [Nume, setNume] = useState('Plasa cu clema 9x32');
...
export default CreateProdusPlasaCuClema9x32;
