...
import CreateProdus from './CreateProdusPage.js';
...
function CreateProdusPlasaTipRulou() {
  ...
  //Campuri
  const [Nume, setNume] = useState('Plasa tip rulou');
  ...
  const createHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${API_LINK}/api/produsePlasaTipRulou`,
        {
          Nume,
          NumeCuloare,
          Pret,
...
export default CreateProdusPlasaTipRulou;
