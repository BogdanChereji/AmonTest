...
function CreateProdusPlasaCuBalamale17x25() {
  ...
  //Campuri
  const [Nume, setNume] = useState('Plasa cu balamale 17x25');
            ...
            <Grid item xs={6}>
              <FormGroup>
                <TextField
                  ...
                  id="numeProdus"
                  aria-readonly
                  value="Plasac cu balamale 17x25"
                  required
...
export default CreateProdusPlasaCuBalamale17x25;
